"""
Django settings for ShuttleBuilder project.
...
SECRET_KEY = 'django-insecure-a(0&xr@@(!-rx@w6*12(pnf*a*wh1^duirj-(3pxzsdv_-a&ei'
SESSION_COOKIE_NAME = 'SHUTTLE_BUILDER_IBCS_SESSION_ID'
# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get('MODE') != 'prod'
...
AUTHENTICATION_BACKENDS = ['main_app.backend.ELNBackend']
...
ROOT_URLCONF = 'ShuttleBuilder.urls'
...
WSGI_APPLICATION = 'ShuttleBuilder.wsgi.application'
...
ASGI_APPLICATION = 'ShuttleBuilder.asgi.application'
