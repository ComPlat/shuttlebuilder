...
class ShuttleLoginController extends AbstractSDC {

    constructor() {
        super();
        this.contentUrl = "/sdc_view/main_app/shuttle_login"; //<shuttle-login></shuttle-login>
...
app.register(ShuttleLoginController, false);